  ...
  return (
    ...
    >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="w-7 h-7 md:w-9 md:h-9 text-[#25D366] drop-shadow-[0_2px_10px_rgba(37,211,102,0.4)] relative z-10 group-hover:scale-110 transition-transform duration-300"
      >
